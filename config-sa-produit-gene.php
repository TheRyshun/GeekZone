                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" style="text-align: center;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="config-sa-produit-new.php" class="btn btn-dark" type="button" style="background-color:#00b760;">Nouveau produit<br></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="config-sa-produit-modif.php" class="btn btn-dark" type="button" style="background-color:#00b760;">Modifier informations d'un produit<br></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="config-sa-produit-supp.php" class="btn btn-dark" type="button" style="background-color:#00b760;">Supprimer un produit<br></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="config-sa-produit-ensemble.php" class="btn btn-dark" type="button" style="background-color:#00b760;">Insérer un ensemble de produits<br></a></td>
                                        </tr>
