        ...
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="margin-top:-20px;">
            <div class="container"><a class="navbar-brand" href="#" style="color:#00b760;"><img src="assets/img/logo_geek.jpg" style="width:100px;height:100px;"><em>GeekZone</em></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav mr-auto"></ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="index.php" style="background-color:#f26877;">Déconnexion</a></span></div>
    </div>
    </nav>
    </div>
    <div class="highlight-clean" style="background-color:rgb(238,244,247);padding-bottom:100px;">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Configuration des éléments</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" style="text-align: center;">
                                    ...
                                    <tbody>
                                        <tr>
                                          <td><a href="register.php" class="btn btn-dark" type="button" style="background-color:#00b760;">BOUTIQUE<br></a></td>
                                        </tr>
                                        <tr>
                                          <td><a href="register.php" class="btn btn-dark" type="button" style="background-color:#00b760;">PRODUITS<br></a></td>
                                        </tr>
                                        <tr>
                                            <td><a href="register.php" class="btn btn-dark" type="button" style="background-color:#00b760;">MOT DE PASSE<br></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
